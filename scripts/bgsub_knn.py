...
def main(input_folder = ".",
    ...
    for i, filename in enumerate(filenames):
        ...
        pred = np.uint8((pred==255)*255) # this removes the shadow (in theory at least)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dist2Threshold", "-t", type=int, default=400, required=False, help='sensitivity default=400')
